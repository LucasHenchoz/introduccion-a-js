...
function desafioProgramacion3() {
  const tablaAMultiplicar = 7;
  for (let i = 0; i <= 10; i++) {
    console.log(tablaAMultiplicar * i);
  }
}
...
function desafioProgramacion7() {
  ...
  console.log(`La suma de los números impares mayores que 10 y menores que 30 es ${sumaImpares}`);
}
...
function desafioProgramacion9() {
  ...
  console.log(convertirFahrenheitACelsius());
}
...
function desafioProgramacion11() {
  const notas = [10, 7, 5, 10, 4];
  function calcularPromedio(notasFinales) {
    let sumaNotas = 0;
    for (let i = 0; i < notasFinales.length; i++) {
      sumaNotas += notasFinales[i];
    }
    return `Tu promedio es ${sumaNotas / notasFinales.length}`;
  }
...
function desafioProgramacion12() {
  const numerosUsuario = [-2, 4, 8, -2, 10, -5, -7, -1, -3, 1, 3];
  ...
  console.log(devolverNumerosPositivos(numerosUsuario));
}
/*
...
function desafioProgramacion13() {
  const numeros = [51, 5, 6, 20, 9, 2, 4, 47, 3];
  let numeroMaximo = 0;
  for (let i = 0; i < numeros.length; i++) {
...
function desafioProgramacion15() {
  function encontrarNumeroFibonacci(numero) {
    if (numero === 0) {
      return 0;
    } else if (numero === 1) {
      return 1;
    }
    return encontrarNumeroFibonacci(numero - 1) + encontrarNumeroFibonacci(numero - 2);
  }
  console.log(encontrarNumeroFibonacci(6));
}
/*
